 ...
 * @author Amada
 */
public class BajaDeProductos extends javax.swing.JFrame {

    /**
     * Creates new form BajaDeProductos
     */
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(245, 123, 123));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BajaDeProductos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BajaDeProductos().setVisible(true);
            }
        });
    }
