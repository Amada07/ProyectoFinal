 ...
 * @author Amada
 */
public class controlDeExistencias extends javax.swing.JFrame {

    /**
     * Creates new form controlDeExistencias
     */
    public controlDeExistencias() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        registroEntrada = new javax.swing.JButton();
        ...
        registroEntrada.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        registroEntrada.setText("Registro  de Entrada de Productos ");

        alertaStock.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        alertaStock.setText("Generacion de Alertas de Stock ");

        registroSalida.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        registroSalida.setText("Registro de Salida de Productos ");

        historialStock.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        historialStock.setText("Visualizacion de Historial de Movimientos de Stock ");
        historialStock.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                historialStockActionPerformed(evt);
            }
        });
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(controlDeExistencias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new controlDeExistencias().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton historialStock;
